    ...
    <BasePage>
        <Container>
          <GridContainer>
            <Sidebar>
              <SidebarHeader>
                <Building2 style={{ stroke: '#3b82f6', width: '1.25rem', height: '1.25rem' }} />
                  ...
                  <StylistInfo>
                    ...
                    <div style={{ display: 'flex', gap: '1rem' }}>
                      <p style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <MapPin style={{ stroke: '#3b82f6', width: '1.25rem', height: '1.25rem' }} />
                        {stylist.location}
                      </p>
                      <p style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <Building style={{ stroke: '#3b82f6', width: '1.25rem', height: '1.25rem' }} title="Building" />
                        {stylist.experience}
                      </p>
                    </div>
                    <StylistDescription>{stylist.description}</StylistDescription>
                  </StylistInfo>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                      <Receipt style={{ stroke: '#3b82f6', width: '1.25rem', height: '1.25rem' }} />
                      <PriceContainer>
                        <span>Chỉ từ</span>
